...
namespace MalbersAnimations.Controller
{
    ...
    public class MAnimalEditor : Editor 
    {
      ...
      //  private ReorderableList Reo_List_Pivots;
        ...
        SerializedProperty
            S_StateList, S_PivotsList, Height, S_Mode_List, Editor_Tabs1, Editor_Tabs2, /*ModeIndexSelected,*/ ModeShowAbilities, OnEnterExitStates, RB,Anim, //PivotPosDir,
            m_Vertical, m_Horizontal, m_IDFloat, m_IDInt, m_State, m_LastState, m_Mode, m_Grounded, m_Movement, m_SpeedMultiplier, m_UpDown, OnMainPlayer, currentStance, defaultStance,
        ...
        private void ShowStates()
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUI.indentLevel++;
            EditorGUILayout.PropertyField(OnEnterExitStates, new GUIContent("On Enter/Exit States Events"),true);
            EditorGUI.indentLevel--;
            EditorGUILayout.EndVertical();
